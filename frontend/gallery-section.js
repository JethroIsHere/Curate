document.addEventListener("DOMContentLoaded", () => {
        ...
        async function fetchAndRenderArtworks() {
            ...
            try {
                ...
                pagedArtworks.forEach((art, index) => {
                    ...
                    // Ensure we have a sensible filename; if missing, try to derive from title
                    ...
                    img.alt = art.title || artFilename || 'Artwork';
    ...
    if (mobileSearchBtn && desktopSearchInput) {
        mobileSearchBtn.addEventListener('click', () => {
            // On mobile, focus the central search input (it acts as the main search control)
